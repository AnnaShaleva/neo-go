...
var (
	...
	faunCSS = map[string]string{
		...
		nativenames.Policy:   `{"id":-7,"hash":"0xcc5e4edd9f5f8dba8bb65734541df7a1c081c67b","nef":{"magic":860243278,"compiler":"neo-core-v3.0","source":"","tokens":[],"script":"EEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0A=","checksum":2681632925},"manifest":{"name":"PolicyContract","abi":{"methods":[{"name":"blockAccount","offset":0,"parameters":[{"name":"account","type":"Hash160"}],"returntype":"Boolean","safe":false},{"name":"getAttributeFee","offset":7,"parameters":[{"name":"attributeType","type":"Integer"}],"returntype":"Integer","safe":true},{"name":"getBlockedAccounts","offset":14,"parameters":[],"returntype":"InteropInterface","safe":true},{"name":"getExecFeeFactor","offset":21,"parameters":[],"returntype":"Integer","safe":true},{"name":"getExecPicoFeeFactor","offset":28,"parameters":[],"returntype":"Integer","safe":true},{"name":"getFeePerByte","offset":35,"parameters":[],"returntype":"Integer","safe":true},{"name":"getMaxTraceableBlocks","offset":42,"parameters":[],"returntype":"Integer","safe":true},{"name":"getMaxValidUntilBlockIncrement","offset":49,"parameters":[],"returntype":"Integer","safe":true},{"name":"getMillisecondsPerBlock","offset":56,"parameters":[],"returntype":"Integer","safe":true},{"name":"getStoragePrice","offset":63,"parameters":[],"returntype":"Integer","safe":true},{"name":"getWhitelistFeeContracts","offset":70,"parameters":[],"returntype":"InteropInterface","safe":true},{"name":"isBlocked","offset":77,"parameters":[{"name":"account","type":"Hash160"}],"returntype":"Boolean","safe":true},{"name":"recoverFund","offset":84,"parameters":[{"name":"account","type":"Hash160"},{"name":"token","type":"Hash160"}],"returntype":"Boolean","safe":false},{"name":"removeWhitelistFeeContract","offset":91,"parameters":[{"name":"contractHash","type":"Hash160"},{"name":"method","type":"String"},{"name":"argCount","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setAttributeFee","offset":98,"parameters":[{"name":"attributeType","type":"Integer"},{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setExecFeeFactor","offset":105,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setFeePerByte","offset":112,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setMaxTraceableBlocks","offset":119,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setMaxValidUntilBlockIncrement","offset":126,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setMillisecondsPerBlock","offset":133,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setStoragePrice","offset":140,"parameters":[{"name":"value","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setWhitelistFeeContract","offset":147,"parameters":[{"name":"contractHash","type":"Hash160"},{"name":"method","type":"String"},{"name":"argCount","type":"Integer"},{"name":"fixedFee","type":"Integer"}],"returntype":"Void","safe":false},{"name":"unblockAccount","offset":154,"parameters":[{"name":"account","type":"Hash160"}],"returntype":"Boolean","safe":false}],"events":[{"name":"MillisecondsPerBlockChanged","parameters":[{"name":"old","type":"Integer"},{"name":"new","type":"Integer"}]},{"name":"WhitelistFeeChanged","parameters":[{"name":"contract","type":"Hash160"},{"name":"method","type":"String"},{"name":"argCount","type":"Integer"},{"name":"fee","type":"Any"}]},{"name":"RecoveredFund","parameters":[{"name":"account","type":"Hash160"}]}]},"features":{},"groups":[],"permissions":[{"contract":"*","methods":"*"}],"supportedstandards":[],"trusts":[],"extra":null},"updatecounter":0}`,
		nativenames.Oracle:   `{"id":-9,"hash":"0xfe924b7cfe89ddd271abaf7210a80a7e11178758","nef":{"magic":860243278,"compiler":"neo-core-v3.0","source":"","tokens":[],"script":"EEEa93tnQBBBGvd7Z0AQQRr3e2dAEEEa93tnQBBBGvd7Z0A=","checksum":2663858513},"manifest":{"name":"OracleContract","abi":{"methods":[{"name":"finish","offset":0,"parameters":[],"returntype":"Void","safe":false},{"name":"getPrice","offset":7,"parameters":[],"returntype":"Integer","safe":true},{"name":"request","offset":14,"parameters":[{"name":"url","type":"String"},{"name":"filter","type":"String"},{"name":"callback","type":"String"},{"name":"userData","type":"Any"},{"name":"gasForResponse","type":"Integer"}],"returntype":"Void","safe":false},{"name":"setPrice","offset":21,"parameters":[{"name":"price","type":"Integer"}],"returntype":"Void","safe":false},{"name":"verify","offset":28,"parameters":[],"returntype":"Boolean","safe":true}],"events":[{"name":"OracleRequest","parameters":[{"name":"Id","type":"Integer"},{"name":"RequestContract","type":"Hash160"},{"name":"Url","type":"String"},{"name":"Filter","type":"String"}]},{"name":"OracleResponse","parameters":[{"name":"Id","type":"Integer"},{"name":"OriginalTx","type":"Hash256"}]}]},"features":{},"groups":[],"permissions":[{"contract":"*","methods":"*"}],"supportedstandards":["NEP-30"],"trusts":[],"extra":null},"updatecounter":0}`,
...
func TestManagement_GenesisNativeState(t *testing.T) {
	...
	t.Run("Huyao enabled", func(t *testing.T) {
		mgmt := newCustomManagementClient(t, func(cfg *config.Blockchain) {
			cfg.Hardforks = map[string]uint32{
				config.HFAspidochelone.String(): 0,
				config.HFBasilisk.String():      0,
...
func TestManagement_NativeDeployUpdateNotifications(t *testing.T) {
	...
	require.Equal(t, 1, len(aer))
	expected = expected[:0]
	for _, h := range []util.Uint160{nativehashes.StdLib, nativehashes.PolicyContract, nativehashes.OracleContract, nativehashes.Notary} {
		expected = append(expected, state.NotificationEvent{
			ScriptHash: nativehashes.ContractManagement,
			Name:       "Update",
			Item: stackitem.NewArray([]stackitem.Item{
	...
	// Check notifications for Gorgon hardfork.
	aer, err = mgmt.Chain.GetAppExecResults(mgmt.Chain.GetHeaderHash(gorgonHeight), trigger.OnPersist)
	require.NoError(t, err)
	require.Equal(t, 1, len(aer))
	expected = expected[:0]
	for _, h := range []util.Uint160{nativehashes.ContractManagement, nativehashes.CryptoLib} {
		expected = append(expected, state.NotificationEvent{
			ScriptHash: nativehashes.ContractManagement,
			Name:       "Update",
			Item: stackitem.NewArray([]stackitem.Item{
...
func TestManagement_WhitelistedUpdate(t *testing.T) {
	...
	// Whitelist some method and check execution price and notifications.
	ctrInvoker := e.NewInvoker(ctr.Hash, e.Committee)
	h1 := ctrInvoker.Invoke(t, stackitem.Make(2), "freeInc", 1) // reference invocation.
	txWhitelist := p.Invoke(t, stackitem.Null{}, "setWhitelistFeeContract", ctr.Hash, "freeInc", 1, 0)
	...
	e.CheckTxNotificationEvent(t, txWhitelist, 0, state.NotificationEvent{
		ScriptHash: nativehashes.PolicyContract,
		Name:       "WhitelistFeeChanged",
		Item: stackitem.NewArray([]stackitem.Item{
			stackitem.Make(ctr.Hash.BytesBE()),
			stackitem.Make("freeInc"),
			stackitem.Make(1),
			stackitem.Make(0),
		}),
	})

	// Update this contract and check that whitelist is cleared.
	ctr.Manifest.Permissions = []manifest.Permission{
		{
			Methods: manifest.WildStrings{
				Value: []string{"update", "destroy", "someNewMethod"},
			},
		},
	}
	rawManifest, err := json.Marshal(ctr.Manifest)
	require.NoError(t, err)
	txUpdate := ctrInvoker.Invoke(t, stackitem.Null{}, "update", stackitem.Make(rawManifest)) // update invalidates all whitelisted methods of the contract.
	...
	e.CheckTxNotificationEvent(t, txUpdate, 0, state.NotificationEvent{
		ScriptHash: nativehashes.PolicyContract,
		Name:       "WhitelistFeeChanged",
		Item: stackitem.NewArray([]stackitem.Item{
			stackitem.Make(ctr.Hash.BytesBE()),
	...
	// Set the whitelist one more time and destroy the contract, check that whitelist is cleared.
	p.Invoke(t, stackitem.Null{}, "setWhitelistFeeContract", ctr.Hash, "freeInc", 1, 0)
	txDestroy := ctrInvoker.Invoke(t, stackitem.Null{}, "destroy") // destroy invalidates all whitelisted methods of the contract.
	e.CheckTxNotificationEvent(t, txDestroy, 0, state.NotificationEvent{
		ScriptHash: nativehashes.PolicyContract,
		Name:       "WhitelistFeeChanged",
		Item: stackitem.NewArray([]stackitem.Item{
			stackitem.Make(ctr.Hash.BytesBE()),
